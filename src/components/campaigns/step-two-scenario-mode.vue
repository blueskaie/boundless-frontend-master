<template lang="pug">
div
  h4.step-heading.mt-5.mb-4(class="input-wrap") {{ $t('campaign.redirectionScenario') }}
    tooltip(class-name="label-help", :label="$t(' campaign.redirectionScenarioHelp ')")
    ...
    v-layout(row)
      ...
      v-flex(xs11)
        v-text-field.transparent(
          ...
          :error-messages="getUrlErrors(scenario.redirectUrl)"
          solo-inverted
          class="url-field"
        )
